...
export default function Projects() {
  ...
  const projectsData = [
      {
          title: "The Helping Society Platform",
      ...
      showcaseLink: "coming-soon"
    },
    {
      title: "VYRO",
      subtitle: "Energy Drink Brand Experience",
      tech: "Figma, Photoshop",
      details: [
        "Built a fictional energy drink brand ecosystem around three distinct product personalities.",
        "Developed visual identities, flavor systems, atmospheric assets, and reusable UI patterns.",
        "Explored light and dark experiences while maintaining consistency across interaction design."
      ],
      images: [
        "/projects/VYRO-1.png",
        "/projects/VYRO-2.png",
      ...
      demoLink: "https://www.figma.com/proto/VLDnUiRrkZ9EvdBFe2wr0O/VYRO?page-id=107%3A2&node-id=186-391&p=f&viewport=9%2C64%2C0.17&t=fhk38uMqSDpVUWr2-1&scaling=scale-down&content-scaling=fixed",
      repoLink: "coming-soon",
      showcaseLink: "https://www.behance.net/gallery/250986325/VYRO-Energy-Drink-Brand-Experience"
    },
    {
      title: "De Ville",
      subtitle: "Vintage Cinematic Car Experience",
      tech: "Figma, Photoshop, Rmove.Bg",
      details: [
        "Designed an immersive editorial experience inspired by vintage luxury and cinematic storytelling.",
        "Created custom assets using Photopea through manual masking and refinement workflows.",
        "Defined the visual direction through typography, moodboards, artifacts, and interaction concepts."
      ],
      images: [
        "/projects/deVille-1.png",
        "/projects/deVille-2.png",
        "/projects/deVille-3.png"
      ],
      demoLink: "https://www.figma.com/proto/nofVN2mvumBiIo891UQ9X4/Panther-De-Ville?node-id=55-63&viewport=474%2C243%2C0.08&t=UMOPTvYdr5zMmmjF-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=1%3A2&page-id=0%3A1https://www.figma.com/proto/nofVN2mvumBiIo891UQ9X4/Panther-De-Ville?node-id=1-2&viewport=474%2C243%2C0.08&t=UMOPTvYdr5zMmmjF-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=1%3A2&page-id=0%3A1",
      repoLink: "coming-soon",
      showcaseLink: "https://www.behance.net/gallery/250218511/De-Ville-Vintage-Cinematic-Car-Experience"
    },
    {
    ...
    },
    {
      ...
      demoLink: "https://chitranshdaiya.github.io/The-Chaos-Sweeper/",
      repoLink: "https://github.com/ChitranshDaiya/The-Chaos-Sweeper",
      showcaseLink: "coming-soon"
    }
  ];
              ...
              <div className="w-full md:w-3/5 flex flex-col">
                ...
                {(project.demoLink !== "coming-soon" || project.repoLink !== "coming-soon") && (
                  <div className="mt-auto pt-6 flex flex-wrap gap-4 border-t-2 border-dashed border-gray-200">
                    ...
                    {project.showcaseLink !== "coming-soon" && (
                      <a href={project.showcaseLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2 bg-white text-[#222] rounded-lg shadow-[2px_2px_0_#222] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0_#222] transition-all font-semibold border-2 border-[#222] text-sm">
                        Showcase
                      </a>
                    )}
                  </div>
