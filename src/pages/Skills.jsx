  ...
  return (
    <div className="min-h-screen bg-brand-bg text-[#222] font-work p-8 md:p-16 relative overflow-hidden">
      <div className="max-w-5xl mx-auto">
        <Link
          to="/"
          className="inline-flex items-center gap-2 mb-8 text-gray-600 hover:text-brand-blue transition font-caveat text-2xl relative z-10"
        >
          <MoveLeft size={24} />
          Back to town
        </Link>
        ...
        >
          <h1 className="font-playfair text-4xl md:text-5xl font-extrabold italic text-brand-blue mb-12">
            Tech Toolkit
          </h1>
            ...
            {skillsData.map((category, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6 z-10">
                  ...
                  <h2 className="font-playfair text-2xl font-bold text-[#222]">
                    {category.title}
                  </h2>
                </div>
